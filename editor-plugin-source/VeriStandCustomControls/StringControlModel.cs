...
namespace NationalInstruments.VeriStand.GrpcPlugins
{
    ...
    [Export(typeof(ICustomVeriStandControl))]
        public class StringControlModelExporter : ICustomVeriStandControl
    {
        /// <summary>
        ...
        public string Target =>
            "<pf:MergeScript xmlns:pf=\"http://www.ni.com/PlatformFramework\">" +
                "<pf:MergeItem>" +
                    "<StringControl xmlns=\"https://github.com/ZhiYang-Ong/VeriStand-gRPC-Plugins\" Width=\"[float]105\" Height=\"[float]50\"/>" +
                "</pf:MergeItem>" +
            "</pf:MergeScript>";
        ...
        /// </summary>
        public string Name => "String Control";
        ...
        public string ImagePath => "/NationalInstruments.VeriStand.GrpcPlugins;component/Resources/gRPC_Ctrl.png";
        ...
        /// </summary>
        public string UniqueId => "StringControl";
    ...
    /// </summary>
    public class StringControlModel : VisualModel, INotifyPropertyChanged,
#if MUTATE2020R4
...
#endif
    {
        ...
        /// </summary>
        private const string StringTextName = "StringControl";
        ...
        /// </summary>
        private const string StringControlModelErrorString = "StringControlModelErrors";
        ...
        {
            get { return new StringControlXamlHelper(); }
        }
        ...
        /// <summary>
        /// Factory method for creating a new StringControlModel
        /// </summary>
        /// <param name="info">Information required to create the model, such as the parser.</param>
        /// <returns>A constructed and initialized StringControlModel instance.</returns>
        [XmlParserFactoryMethod(StringTextName, PluginNamespaceSchema.ParsableNamespaceName)]
        public static StringControlModel Create(IElementCreateInfo info)
        {
            var model = new StringControlModel();
#if MUTATE2020
        ...
        /// </summary>
        private class StringControlXamlHelper : XamlGenerationHelper
        {
            public override Type ControlType => typeof(StringControl);
        }
        #endregion
        ...
        public static readonly PropertySymbol RateSymbol =
            ExposePropertySymbol<StringControlModel>(RatePropName, (double)0);
        public double Rate
        {
