...
namespace NationalInstruments.VeriStand.GrpcPlugins
{
    ...
    [Export(typeof(ICustomVeriStandControl))]
        public class MergeStringModelExporter : ICustomVeriStandControl
    {
        /// <summary>
        ...
        /// </summary>
        public string Name => "Merge String";
        ...
        /// </summary>
        public string ToolTip => "An user control with two inputs and one output.";
        ...
        /// </summary>
        public string UniqueId => "MergeString";
...
#endif
    {
        ...
        /// </summary>
        private const string StringTextName = "MergeString";
        ...
        public static MergeStringModel Create(IElementCreateInfo info)
        {
            var model = new MergeStringModel();
#if MUTATE2020
        ...
        private void ReportErrorToModel(Exception ex)
        {
            ...
            Host.BeginInvoke(AsyncTaskPriority.WorkerHigh, () =>
            {
                MessageScope?.AllMessages.ClearMessageByCategoryAndReportingElement(
                    ...
                    this);
#if MUTATE2021
                this.SafeReportError(MergeStringModelErrorString, null, MessageDescriptor.Empty, ex);
#else
                this.ReportError(MergeStringModelErrorString, null, MessageDescriptor.Empty, ex);
#endif
            });
        }
